...
1. binaries : List of Guix packages the provides binaries.
...
1. BUILD : variable that refer to the build directory.
...
1. PACKAGES : variable that refer to the list of Guix packages of the environment.
...
1. INIT : variable that refer to init file of the bash session in the environment.
...
1. init : Makefile target that tangles necesseary files.
