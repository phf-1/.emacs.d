...
#+begin_src emacs-lisp
(add-to-list 'load-path (file-name-concat user--packages "total-recall/_dist"))
(use-package total-recall
  :demand
  :custom
  (total-recall-database (file-name-concat (expand-file-name user-emacs-directory) "total-recall.sqlite3")))
#+end_src
