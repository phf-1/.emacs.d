...
(setq org-todo-keywords
      '((sequence "TODO(t)" "READY(r)" "WAITING(w)" "DOING(o)" "|" "DONE(d)" "FAILED(f)" "CANCELED(c)")))
...
Then, a detailed summary may be deduced with ~C-c p~ when point on some heading.
#+begin_src emacs-lisp
(global-set-key (kbd "C-c p") #'org-clock-display)
#+end_src
